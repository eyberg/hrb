                      ...
                      module Thrift
                        module Hbase
                          class Client
                            ...
                            def scannerOpenWithStopStartTs(tableName, startRow, stopRow, columns, startTimestamp, stopTimestamp)
                            ...
                            def send_scannerOpenWithStopStartTs(tableName, startRow, stopRow, columns, startTimestamp, stopTimestamp)
                              send_message('scannerOpenWithStopStartTs', ScannerOpenWithStopStartTs_args, :tableName => tableName, :startRow => startRow, :stopRow => stopRow, :columns => columns, :startTimestamp => startTimestamp, :stopTimestamp => stopTimestamp)
                            end

                            def recv_scannerOpenWithStopStartTs()
                              result = receive_message(ScannerOpenWithStopStartTs_result)
                              return result.success unless result.success.nil?
                              raise result.io unless result.io.nil?
                              raise ::Thrift::ApplicationException.new(::Thrift::ApplicationException::MISSING_RESULT, 'scannerOpenWithStopStartTs failed: unknown result')
                            end
                          ...
                          class Processor
                            ...
                            def process_scannerOpenWithStopStartTs(seqid, iprot, oprot)
                              args = read_args(iprot, ScannerOpenWithStopStartTs_args)
                              result = ScannerOpenWithStopStartTs_result.new()
                              begin
                                result.success = @handler.scannerOpenWithStopStartTs(args.tableName, args.startRow, args.stopRow, args.columns, args.startTimestamp, args.stopTimestamp)
                              rescue Apache::Hadoop::Hbase::Thrift::IOError => io
                                result.io = io
                              end
                              write_result(result, oprot, 'scannerOpenWithStopStartTs', seqid)
                            end
                          ...
                          class ScannerOpenWithStopStartTs_args
                            include ::Thrift::Struct
                            TABLENAME = 1
                            STARTROW = 2
                            STOPROW = 3
                            ...
                            ::Thrift::Struct.field_accessor self, :tableName, :startRow, :stopRow, :columns, :startTimestamp, :stopTimestamp
                            FIELDS = {
                              TABLENAME => {:type => ::Thrift::Types::STRING, :name => 'tableName'},
                              STARTROW => {:type => ::Thrift::Types::STRING, :name => 'startRow'},
                              STOPROW => {:type => ::Thrift::Types::STRING, :name => 'stopRow'},
                              COLUMNS => {:type => ::Thrift::Types::LIST, :name => 'columns', :element => {:type => ::Thrift::Types::STRING}},
                              STARTTIMESTAMP => {:type => ::Thrift::Types::I64, :name => 'startTimestamp'},
                              STOPTIMESTAMP => {:type => ::Thrift::Types::I64, :name => 'stopTimestamp'}
                            }
                          ...
                          class ScannerOpenWithStopStartTs_result
                            include ::Thrift::Struct
                            SUCCESS = 0
                            IO = 1
